export default function SwitchRoximo2({ dataTab }) {
  return (
    <>
      <div className="wrapper_for_smart_home_item_3" data-tab={dataTab}>
        <img
          src="./assets/img/3-switch/Выключатель ROXIMO 2кл.png"
          alt="Выключатель ROXIMO 2кл"
          className="image_tab"
        />
        ...
        <div className="price_tab">Стоимость 17 200 тг</div>
      </div>
    </>
  );
}
