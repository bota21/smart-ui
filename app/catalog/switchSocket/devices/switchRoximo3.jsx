export default function SwitchRoximo3({ dataTab }) {
  return (
    <>
      <div className="wrapper_for_smart_home_item_3" data-tab={dataTab}>
        <img
          src="./assets/img/3-switch/Выключатель ROXIMO 3кл.png"
          alt="Выключатель ROXIMO 3кл"
          className="image_tab"
        />
        ...
        <div className="price_tab">Стоимость 19 700 тг</div>
      </div>
    </>
  );
}
