export default function Switch_Bseed_keyboard_4x({ activeTab, tabNumber }) {
  return (
    <>
      <div
      ...
      >
        <img
          src="../assets/img/3-Switch/Выключатель BSEED клавишный 4х.png"
          alt="Выключатель BSEED клавишный 4х"
          className="image_tab"
