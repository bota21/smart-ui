...
import Switch_Yandex_1x from "./SwitchYandex_1x";
import Switch_Yandex_2x from "./Switch_Yandex_2x";
import Switch_Bseed_keyboard_1x from "./Switch_Bseed_keyboard_1x";
import Switch_Bseed_keyboard_2x from "./Switch_Bseed_keyboard_2x";
import Switch_Bseed_keyboard_3x from "./Switch_Bseed_keyboard_3x";
import Switch_Bseed_sensor_1x from "./Switch_Bseed_sensor_1x";
import Switch_Bseed_sensor_2x from "./Switch_Bseed_sensor_2x";
import Switch_Bseed_sensor_3x from "./Switch_Bseed_sensor_3x";
import Switch_Bseed_keyboard_4x from "./Switch_Bseed_keyboard_4x";
import Switch_Roximo_1x from "./Switch_Roximo_1x";
import Switch_Roximo_2x from "./Switch_Roximo_2x";
import Switch_Roximo_3x from "./Switch_Roximo_3x";
import Switch_Aqara_1x from "./Switch_Aqara_1x";
import Switch_Aqara_2x from "./Switch_Aqara_2x";
import Switch_Aqara_3x from "./Switch_Aqara_3x";
import Switch_Aqara_4x from "./Switch_Aqara_4x";
import Dimmer_Bseed from "./Dimmer_Bseed";
import Dimmer_Yandex from "./Dimmer_Yandex";
import Dimmer_Aqara from "./Dimmer_Aqara";
import Switch_roller_touch from "./Switch_roller_touch";
import Socket_buildIn_1x from "./Socket_buildIn_1x";
import Socket_buildIn_2x from "./Socket_buildIn_2x";
import Socket_buildIn_3x from "./Socket_buildIn_3x";
import Relay_dimmer from "./Relay_dimmer";
import Slug_Yandex from "./Slug_Yandex";
import Slug_Tuya from "./Slug_Tuya";
import Slug_Roximo from "./Slug_Roximo";
import Slug_Smartlife from "./Slug_Smartlife";
import Relay_Yandex_1x from "./Relay_Yandex_1x";
import Relay_Yandex_2x from "./Relay_Yandex_2x";
import Button_Yandex from "./Button_Yandex";
import Smart_Din_63A from "./Smart_Din_63A";
import Smart_Din_40A from "./Smart_Din_40A";
import Smart_Din_Moes_16A from "./Smart_Din_Moes_16A";
import Smart_Din_Tuya_63A from "./Smart_Din_Tuya_63A";
