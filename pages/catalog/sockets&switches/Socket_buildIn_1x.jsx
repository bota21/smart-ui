export default function Socket_buildIn_1x({ activeTab, tabNumber }) {
  return (
    <>
      <div
      ...
      >
        <img
          src="../assets/img/3-socket/Розетка Bseed 1х - white.png"
          alt="Розетка Bseed 1х - white"
          className="image_tab"
        ...
        <div className="wrapper_for_images_many">
          <img
            src="../assets/img/3-socket/Розетка Bseed 1х - gold.png"
            alt="Розетка Bseed 1х - gold"
            className="images_many"
            onclick="toggleZoom(this)"
          />
          <img
            src="../assets/img/3-socket/Розетка Bseed 1х - grey.png"
            alt="Розетка Bseed 1х - grey"
            className="images_many"
            onclick="toggleZoom(this)"
          />
          <img
            src="../assets/img/3-socket/Розетка Bseed 1х - black.png"
            alt="Розетка Bseed 1х - black"
            className="images_many"
            onclick="toggleZoom(this)"
          />
        </div>
