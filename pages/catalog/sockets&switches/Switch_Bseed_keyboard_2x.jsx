export default function Switch_Bseed_keyboard_2x({ activeTab, tabNumber }) {
  return (
    <>
      <div
      ...
      >
        <img
          src="../assets/img/3-Switch/Выключатель BSEED клавишный 2х.png"
          alt="Выключатель BSEED клавишный 2х"
          className="image_tab"
