export default function Switch_Yandex_1x({ activeTab, tabNumber }) {
  return (
    <>
      <div
      ...
      >
        <img
          src="../assets/img/3-Switch/Выключатель Яндекс одноклавишный.png"
          alt="Выключатель Яндекс одноклавишный"
          className="image_tab"
