export default function Bulb_GX53_9_Yandex({ activeTab, tabNumber }) {
  return (
    <>
      <div
      ...
      >
        <img
          src="../assets/img/4-light/GX,GU/Лампочка GX53 9W 806 Лм Яндекс RGB.png"
          alt="Лампочка GX53 9W 806 Лм Яндекс RGB"
          className="image_tab"
        ...
        <div className="price_tab">
          <span data-i18n="Cost">Стоимость</span>9 900
