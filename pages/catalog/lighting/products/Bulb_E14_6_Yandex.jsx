export default function Bulb_E14_6_Yandex({ activeTab, tabNumber }) {
  return (
    <>
      <div
      ...
      >
        <img
          src="../assets/img/4-light/Е14/Лампочка Е14 6W 520 Лм Яндекс RGB.png"
          alt="Лампочка Е14 6W 520 Лм Яндекс RGB"
          className="image_tab"
        ...
        <div className="price_tab">
          <span data-i18n="Cost">Стоимость</span>9 300
