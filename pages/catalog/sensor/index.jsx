...
import Sensor_Vibration from "./Sensor_vibration";
import Sensor_Open from "./Sensor_open";
import Sensor_Open_Yandex from "./Sensor_open_Yandex";
import Sensor_Light_Aqara from "./Sensor_light_Aqara";
import Sensor_human_Presence_Aqara_FP1 from "./Sensor_human_presence_Aqara_FP1";
import Sensor_human_Presence_Aqara_FP2 from "./Sensor_human_presence_Aqara_FP2";
import Sensor_Move_Aqara from "./Sensor_move_Aqara";
import Sensor_Move_Yandex from "./Sensor_move_Yandex";
import Sensor_human_Presence_Roximo from "./Sensor_human_presence_Roximo";
import Sensor_Move_Sber from "./Sensor_move_Sber";
import Sensor_Move_Ewelink from "./Sensor_move_Ewelink";
import Sensor_Temperature_Yandex from "./Sensor_temperature_Yandex";
import Sensor_Temperature_Monitor from "./Sensor_temperature_monitor";
import Sensor_Temperature_Kojimo from "./Sensor_temperature_Kojimo";
import Sensor_Temperature_Sonoff from "./Sensor_temperature_Sonoff";
import Sensor_Air_Aqara from "./Sensor_air_Aqara";
import Sensor_Air_QingPing from "./Sensor_air_QingPing";
import Sensor_Water_Yandex from "./Sensor_water_Yandex";
import Sensor_Water_Sonoff from "./Sensor_water_Sonoff";
import Sensor_Water_Aqara from "./Sensor_water_Aqara";
import Sensor_Gas_Aqara from "./Sensor_gas_Aqara";
import Sensor_Gas_Smartlife from "./Sensor_gas_Smartlife";
import Sensor_Gas_Metan from "./Sensor_gas_metan";
import Sensor_Gas_Propan from "./Sensor_gas_propan";
import Sensor_Smoke_Smartlife from "./Sensor_smoke_Smartlife";
import Sensor_Smoke_Aqara from "./Sensor_smoke_Aqara";
import Sensor_Smoke_Tuya from "./Sensor_smoke_Tuya";
