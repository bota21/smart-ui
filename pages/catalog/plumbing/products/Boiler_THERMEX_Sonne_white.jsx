export default function Boiler_THERMEX_Sonne_white({ activeTab, tabNumber }) {
  return (
    <>
      <div
      ...
      >
        ...
        <div className="text_tab">
          <span data-i18n="Boiler_THERMEX_Sonne_white_text">
            Электрический настенный котел Sonne 12 Wi-Fi White от THERMEX - это
            ...
            драгоценное пространство, а стильный белый дизайн гармонично
            впишется в любой интерьер. Котел Sonne 12 Wi-Fi White оснащен
